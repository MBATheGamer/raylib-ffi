...
fn main() {
  ...
  let target = RenderTexture::default();
  let source_rect = Rectangle::default();
  let dest_rect = Rectangle::default();
  ...
  let viewport_type = ViewportType::KeepAspectInteger;
