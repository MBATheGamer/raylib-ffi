...
unsafe extern "C" {
  ...
  pub unsafe fn DrawLineBezier(start_pos: Vector2, end_pos: Vector2, thick: f32, color: Color);
  pub unsafe fn DrawLineDashed(
    start_pos: Vector2,
    end_pos: Vector2,
    dash_size: i32,
    space_size: i32,
  ...
  pub unsafe fn DrawPoly(center: Vector2, sides: i32, radius: f32, rotation: f32, color: Color);
  pub unsafe fn DrawPolyLines(
    center: Vector2,
    sides: i32,
    radius: f32,
    rotation: f32,
