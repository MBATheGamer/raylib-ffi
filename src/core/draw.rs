use crate::{
  core::ffi::{
    ...
    BeginTextureMode, BeginVrStereoMode, ClearBackground, EndBlendMode, EndDrawing, EndMode2D,
    EndMode3D, EndScissorMode, EndShaderMode, EndTextureMode, EndVrStereoMode,
  },
  enums::BlendMode,
